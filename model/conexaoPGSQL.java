...
public class conexaoPGSQL {
    ...
    /**
     * Esse metodo realiza a conexao com o banco, ele precisa de tres
     * argumentos, o primeiro, recebe o endereço do banco, o segundo recebe o
     * nome do usuario e o terceiro recebe a senha do banco de dados.
     *
     * EXP: "jdbc:postgresql://localhost:5432/sis_comanda", "postgres",
     * "Euamojesus"
     *
     */
//  ConexaoPGSQL banco = new ConexaoPGSQL();
//  banco.Conectar("jdbc:postgresql://localhost:5432/sis_comanda", "postgres", "Euamojesus");
    public void Conectar(String strEnd, String strUsuario, String strSenha) {
        /**
         * Recebendo o endereco,usuario e senha do usuario e repassando para a
         * variavel global
         */
        endereco = strEnd;
        usuario = strUsuario;
        ...
        try {
            ...
            /**
             * Retorna um erro caso nao encontre o driver, ou alguma informacao
             * sobre o mesmo esteja errada
             */
